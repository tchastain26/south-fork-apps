    ...
    write_page(
        ...
        render_simple_page(
            ...
            sections=[
                ...
                ("Advertising", "South Fork Apps carries no advertising. The tools are free to use, with no ads, no accounts and no tracking cookies."),
    ...
    write_page(
        ...
        render_simple_page(
            ...
            bullets=[
                ...
                "South Fork Apps shows no ads and sets no advertising cookies.",
            ],
            sections=[
                ...
                ("Site infrastructure", "Like most public websites, South Fork Apps may rely on standard hosting, CDN, and security infrastructure that can log normal request data such as IP address, browser details, referral data, and performance diagnostics."),
                ("Advertising", "South Fork Apps does not show ads and does not use advertising cookies. It does not sell personal information."),
